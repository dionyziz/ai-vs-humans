...
export const events: Event[] = [
  ...
  // ERA 3
  {
    ...
    category: "machine",
    superhuman: true,
    text: "World checkers champion Marion Tinsley withdraws from his title defence against the program Chinook after six drawn games, citing illness. The title passes to a machine for the first time. Tinsley, who lost only seven games in a 45-year career, never lost one to Chinook.",
    era: 3,
